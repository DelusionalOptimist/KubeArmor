...
func (c *reversePolicyServiceClient) ContainerPolicy(ctx context.Context, opts ...grpc.CallOption) (ReversePolicyService_ContainerPolicyClient, error) {
	stream, err := c.cc.NewStream(ctx, &ReversePolicyService_ServiceDesc.Streams[0], "/policy.ReversePolicyService/containerPolicy", opts...)
	if err != nil {
		return nil, err
	}
...
func (c *reversePolicyServiceClient) HostPolicy(ctx context.Context, opts ...grpc.CallOption) (ReversePolicyService_HostPolicyClient, error) {
	stream, err := c.cc.NewStream(ctx, &ReversePolicyService_ServiceDesc.Streams[1], "/policy.ReversePolicyService/hostPolicy", opts...)
	if err != nil {
		return nil, err
	}
